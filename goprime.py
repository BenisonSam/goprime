...
if __name__ == "__main__" and 1 < len(sys.argv) < 5:
    ...
    if mode == "black":
        ...
        Position.print(MCTree.tree_search(TreeNode(net=net, pos=Position.empty_position(N)),
                                          N_SIMS, W * W * [0], disp=True).pos)
    elif mode == "selfplay":
        game.selfplay(net)
    elif mode == "replay_train":
        # find GoGoD-2008-Winter-Database/ -name '*.sgf' | shuf | python ./goprime.py replay_train
        game.replay_train(net)
